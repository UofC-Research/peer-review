# Public Summary: What This Project Studies and Why It Matters
...
- Are core results usually stable, or do they often change?
- Does peer review mainly affect how results are reported, or what the results are?
- Are some types of changes common while others are rare?
...
- an original **preprint**, and
- its corresponding **peer-reviewed published version**

For each pair, the project records whether specific, clearly defined features of the paper change between versions.

Examples of features tracked include:

- Whether results are reported more clearly
- Whether uncertainty (such as confidence intervals) is added
...
- Claim that peer review causes improvements or harm
- Rank journals, authors, or research fields
- Judge whether research is “good” or “bad”
- Decide whether preprints or peer-reviewed papers are more trustworthy
...
- recording how often they happen
- reporting patterns clearly
...
- are similar in other scientific or academic fields
- hold across different preprint platforms
