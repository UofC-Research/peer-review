# 📍 Reader’s Map: How to Read This Project

## What This Project Is About (30-Second Version)
...
> *What changes—if anything—can be observed between preprint and published versions of the same manuscript?*
...
**What Study 1 does not do**

- ❌ No causal claims
- ❌ No explanations of *why* changes occur
- ❌ No comparisons across journals, institutions, or academic systems

**Why this matters**

If measurement is unstable or underspecified, any explanation built on top of it is unreliable.

> **Study 1 establishes the measurement baseline.**  
...
- Treat Study 1 outputs (ΔVₖ, PRES) as **fixed inputs**
- Examine **associational heterogeneity** across contextual variables
- Use the **same preprint ecosystem** as Study 1

**What Study 2 still does not do**

- ❌ No causal inference
- ❌ No revision of Study 1 indicators or scoring rules
- ❌ No retroactive hypothesis generation

**Why this is a separate study**

Contextual variables dramatically increase researcher degrees of freedom.  
...
- Expand to additional preprint servers (e.g., arXiv, SSRN, ChemRxiv)
- Treat **preprint server** as a **design variable**, not a quality signal
- Evaluate **measurement portability**, not peer-review effectiveness

**What Study 3 avoids**

- ❌ Ranking platforms or review systems
- ❌ Normative claims about which ecosystem is “better”
- ❌ Reinterpreting or revising Study 1 findings
...
- **Null or near-null findings are substantively informative**
- Stability can be as meaningful as change
- Observed patterns are treated as **descriptions of practice**, not judgments of quality
