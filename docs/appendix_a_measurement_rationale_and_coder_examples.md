# Appendix A — Measurement Rationale and Coder Decision Examples

**Status:** Preregistered, binding  
**Scope:** Applies to indicators V1–V10 for all manuscript versions  
...
These materials are **interpretive aids only** and do **not** modify:

- Indicator definitions  
- Scoring thresholds  
- Aggregation procedures (e.g., Raw Score, PRES)  
- Inclusion or exclusion rules  

All scoring remains based exclusively on **observable reporting content**, applied **symmetrically** to preprint and published versions, in accordance with the preregistered codebook.
...
- Scoring reflects **reporting transparency**, not correctness or quality  
- Preprint and published versions are scored **independently**  
- Evidence excerpts are logged **verbatim** for every score  
...
This indicator captures whether a manuscript reports a **quantitative effect estimate with sufficient clarity to permit interpretation**, independent of magnitude or correctness. Prior comparative studies consistently show high stability of effect direction and magnitude between preprints and published articles, while reporting clarity varies. V1 therefore detects the *presence and explicitness* of effect estimates rather than substantive analytical change.
### Coder decision examples
- **Score 0:** “Treatment A improved outcomes compared to control.” (No numeric estimate.)
- **Score 1:** Direction reported but magnitude unclear, or effect shown only via unlabeled figures.
- **Score 2:** Explicit effect estimate reported with direction and magnitude on a defined scale (e.g., RR = 0.82).
...
- **Score 2:** Uncertainty consistently reported for all primary estimates.
...
- **Score 2:** Exact p-values reported.
...
- **Score 2:** Explicit calculation with stated assumptions (e.g., alpha, power, effect size).
...
- **Score 2:** Model, covariates, and assumptions clearly specified.
...
- **Score 2:** Explicit correction or prespecified outcome hierarchy described.
...
### Measurement rationale
This indicator assesses whether authors report analyses examining robustness to alternative assumptions or specifications. It captures presence and breadth without evaluating necessity or rigor.

### Coder decision examples
- **Score 0:** No robustness or sensitivity analyses reported.
- **Score 1:** Single or limited robustness analysis.
- **Score 2:** Multiple or systematic robustness analyses.
...
- **Score 2:** Explicit handling method described (e.g., imputation, complete-case analysis).
...
- **Score 2:** Publicly accessible data, code, or protocol provided.
...
- **Score 2:** Comprehensive reporting consistent with CONSORT/STROBE norms.
...
- When uncertainty exists, assign the **lower score**  
- All scores must be supported by **verbatim evidence excerpts**  
...
---
## Transition: Binding vs Non-Binding Materials

The sections above constitute **Appendix A**, which is preregistered and binding.  
The sections below provide **non-binding implementation guidance** intended to support coder training, consistency, and adjudication.

In the event of any discrepancy, **Appendix A and the preregistered codebook govern**. No analytic flexibility is introduced by these examples.

---
# Non-Binding Coder Decision Examples & Adjudication Guide

This section provides **illustrative coder decision examples** intended to standardize the application of **already-preregistered scoring rules** for the Statistical Rigor Indicators (V1–V10).

This document is **non-binding**, **non-preregistered**, and **does not alter**:
- Indicator definitions  
- Scoring thresholds  
- Aggregation rules (e.g., Raw Score, PRES)  
...
- Promote **consistent application** of preregistered rules  
- Reduce coder drift across time or personnel  
- Improve **auditability and transparency**  
- Provide concrete examples for training and adjudication  
...
- Scores reflect **observable reporting only**, not correctness or intent  
- Preprint and published versions are scored **independently**  
- Evidence excerpts are logged verbatim for every score  
- When ambiguity exists, the **lower score is assigned**  
- Supplementary materials may **supplement but not replace** missing core reporting  
...
- Uncertainty reported for one outcome only  
...
1. Each coder documents their score and evidence excerpt  
2. Discrepancies are reviewed against the **preregistered codebook criteria**  
3. The **lowest defensible score** consistent with preregistered rules is assigned  
4. The adjudication rationale is logged  
...
- ✅ Clarifies application of preregistered rules  
- ❌ Does not modify indicators or thresholds  
- ❌ Does not introduce new analytic decisions  
- ❌ Does not affect composite score construction  
...
- All updates must preserve consistency with the preregistered codebook  
