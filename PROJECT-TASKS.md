...
| `peer_elt.acquire.tdm`           | Covered by TDM acquisition tests                                  | Complete for injectable bioRxiv/medRxiv TDM archive sync, published-link metadata download, and XML-first published full-text retrieval automation | Wire into production CLI/jobs if bulk TDM retrieval is selected                             |
